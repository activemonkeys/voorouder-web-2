// packages/grid/src/locales/ag-grid-nl.ts
/**
 * Please note:
 *
...
export const AG_GRID_LOCALE_NL = {
  ...
  advancedFilterValidationMissingQuote:
    'Waarde mist een aanhalingsteken aan het einde',
  ...
  advancedFilterValidationJoinOperatorMismatch:
    'Logische operatoren binnen een voorwaarde moeten gelijk zijn',
  advancedFilterValidationInvalidJoinOperator:
    'Logische operator niet gevonden',
  ...
  advancedFilterValidationMessage:
    'Uitdrukking bevat een fout. ${variable} - ${variable}.',
  advancedFilterValidationMessageAtEnd:
    'Uitdrukking bevat een fout. ${variable} aan het einde van de uitdrukking.',
  ...
  advancedFilterBuilderValidationIncomplete:
    'Niet alle voorwaarden zijn voltooid.',
  ...
  pageSizeSelectorLabel: 'Per Pagina:',
  footerTotal: 'Totaal',
  ...
  pivotChartRequiresPivotMode:
    'Draai Grafiek vereist Draai Modus ingeschakeld.',
  ...
  ariaAdvancedFilterBuilderItem:
    '${variable}. Niveau ${variable}. Druk op ENTER om te bewerken',
  ...
  ariaPageSizeSelectorLabel: 'Per Pagina',
  ...
  ariaDropZoneColumnValueItemDescription:
    'Druk op ENTER om het aggregatietype te wijzigen',
  ...
  ariaLabelRichSelectDeselectAllItems:
    'Druk op VERWIJDEREN om alle items te deselecteren',
  ariaLabelRichSelectDeleteSelection:
    'Druk op VERWIJDEREN om item te deselecteren',
  ...
  ariaLabelAdvancedFilterBuilderAddField:
    'Geavanceerde Filter Builder Veld Toevoegen',
  ariaLabelAdvancedFilterBuilderColumnSelectField:
    'Geavanceerde Filter Builder Kolom Selecteer Veld',
  ariaLabelAdvancedFilterBuilderOptionSelectField:
    'Geavanceerde Filter Builder Optie Selecteer Veld',
  ariaLabelAdvancedFilterBuilderJoinSelectField:
    'Geavanceerde Filter Builder Koppeloperator Selecteer Veld',
